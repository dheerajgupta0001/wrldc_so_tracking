...
{
    /// <inheritdoc />
    public partial class referenceNumber1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReferenceNumbers_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pams_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pams_Owners_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Owners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pams_SubStations_SubStationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pams_DepartmentId",
                table: "Pams",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Pams_OwnerId",
                table: "Pams",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Pams_SubStationId",
                table: "Pams",
                column: "SubStationId");

            migrationBuilder.CreateIndex(
                name: "IX_ReferenceNumbers_DepartmentId",
                table: "ReferenceNumbers",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_SubStations_Acronym",
                table: "SubStations",
                column: "Acronym",
                unique: true);
